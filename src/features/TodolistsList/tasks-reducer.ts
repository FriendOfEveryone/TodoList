import {AddTodolistActionType, RemoveTodolistActionType, RESULT_CODE, SetTodolistsActionType} from './todolists-reducer'
...
export const addTaskTC = (title: string, todolistId: string) =>
   async (dispatch: Dispatch<ActionsType>) => {
      ...
      try {
         ...
         handleServerNetworkError(dispatch, e as AxiosError<ErrorType>)
      }
   }
